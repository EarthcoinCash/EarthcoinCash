# Support for Output Descriptors in EarthcoinCash Core

Since EarthcoinCash Core v0.17, there is support for Output Descriptors in the
...
on EarthcoinCash's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing EarthcoinCash Core wallets, a convenience function `combo` is
