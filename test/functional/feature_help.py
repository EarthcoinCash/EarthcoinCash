...
"""Verify that starting earthcoincash with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start earthcoincash with -h for help text")
        ...
        self.log.info("Start earthcoincash with -version for version information")
        ...
        self.log.info("Start earthcoincashd with -fakearg to make sure it does not start")
